        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-black border-r border-gray-600">
          <ul class="space-y-2 font-medium">
            <li>
              ...
              >
                <img
                  src={dashboardIcon}
                  alt="Dashboard"
                  class="w-5 h-5 transition duration-75 brightness-0 invert opacity-60 group-hover:opacity-100"
                />
            ...
            <li>
              ...
              >
                <svg
                  class="shrink-0 w-5 h-5 text-gray-400 transition duration-75 group-hover:text-yellow-400"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 18 18"
                ...
                <span class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-black bg-yellow-400 rounded-full">
                  Pro
                </span>
              </a>
            </li>
