...
<footer class="flex flex-col items-center justify-center w-full py-20 bg-gradient-to-b from-[#5524B7] to-[#380B60] text-white/70">
  <svg
    width="157"
    height="40"
    viewBox="0 0 157 40"
  ...
  <p class="mt-4 text-center">
    Copyright © 2025 <a href="https://prebuiltui.com">PrebuiltUI</a>. All rights
    reservered.
  </p>
