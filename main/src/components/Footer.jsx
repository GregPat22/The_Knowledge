...
export const Footer = () => {
  return (
    <footer className="flex flex-col items-center justify-center w-full py-32 bg-gradient-to-b from-[#020201] to-[#292929] text-white/70">
      <svg
        width="157"
        height="40"
        viewBox="0 0 157 40"
        ...
        xmlns=""
      ></svg>
      <h2 className="text-white text-2xl font-bold mt-4">The Knowledge</h2>
      <p className="mt-4 text-center">
        Copyright © 2025 <a>TheKnowledge</a>. All rights reservered.
      </p>
